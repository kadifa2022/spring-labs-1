...
public interface AccountRepository extends JpaRepository<Account, Long> {
    ...
    List<Account> findAllByAgeLessThanEqual(Integer age);//int wrapper class
    ...
    List<Account> findByAddressStartingWith(String keyword);//anything

    //Write a derived query to sort the list of accounts with age
    List<Account> findByOrderByAgeDesc();

   // Account findById(Integer Id); //for one account object
